...
Music.openModal = function (opts, btn) {
...
Music.closeModal = function(refresh){
...
Music.closeAllModals = function(refresh){
...
Music.scrollToTopOfModal = function() {
    target = ModalList[ModalList.length - 1];
